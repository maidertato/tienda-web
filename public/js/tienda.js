...
export const inventario = [
  ...
  new Merchandising('Sueter', 35, 'Si tu perro tiembla más que móvil al 1% de batería, este suéter le activa el modo calentito y facherito al instante. Suave, cómodo y fácil de poner, perfecto para paseos, siestas o para que parezca que tiene más estilo que tú sin ningún esfuerzo. Abriga de verdad y deja claro que aquí no se pasa frío, solo se reparte flow.', 'imagenes/productos/sueterPerro.png', 'Cuerpo', 'Mediano', 'Rosa'),
