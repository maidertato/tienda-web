  ...
  return (
    <nav className="nav-expand">
      <ul className="button-container d-flex list-unstyled justify-content-center m-0 p-2 gap-4">
        ...
        {/* Botón de Carrito con el badge dinámico */}
        <li>
          <a href="#" className="nav-btn" data-bs-toggle="offcanvas" data-bs-target="#carrito">
            <div style={{ position: 'relative', display: 'inline-flex' }}>
              ...
              {/* Este número se actualiza automáticamente gracias a la prop cantidadCarrito */}
